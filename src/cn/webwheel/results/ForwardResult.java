...
/**
 * Result to do http forward
 * @see javax.servlet.RequestDispatcher#forward(javax.servlet.ServletRequest, javax.servlet.ServletResponse)
 */
public class ForwardResult extends SimpleResult {
    ...
    public void render() throws IOException, ServletException {
        ctx.getRequest().getRequestDispatcher(path).forward(ctx.getRequest(), ctx.getResponse());
    }
